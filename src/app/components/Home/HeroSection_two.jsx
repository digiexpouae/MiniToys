...
export default function ToyStoreHeader() {
    ...
    return (
        <div className="w-full">
            ...
            {/* Hero Section */}
            <div className="relative w-full aspect-[16/9] md:aspect-[12/4] bg-[url('/assets/homepage/panda.png')] bg-cover  bg-center overflow-hidden">
                {/* Decorative Circles */}
                ...
                <div className="container md:block hidden mx-auto px-8 h-full relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full items-center">
                        {/* Left Content */}
                        <div className="flex flex-col translate-x-1/4 justify-center ">
                ...
                <div className="container mx-auto px-8 h-full w-full relative z-10">
                    ...
                    {/* <div className='absolute bottom-0 right-0 w-2/3 h-2/3 '>
                        <Image src={"/assets/homepage/panda.png"} alt="minion" width={500} height={500} className='object-cover' />

                    </div> */}

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full ">
                        {/* Left Content */}
                        <div className="flex flex-col items-end justify-start h-full   relative z-30">
